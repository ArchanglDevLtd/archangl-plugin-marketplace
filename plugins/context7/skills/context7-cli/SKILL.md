---
name: context7-cli
description: Use the ctx7 CLI to fetch library documentation, manage AI coding skills, and set up Context7 in CLI + Skills mode. Activate when the user mentions "ctx7" or "context7", needs current docs for any library, wants to install/search/generate skills, or needs to set up Context7 for their AI coding agent.
---

# ctx7 CLI

The Context7 CLI does three things: fetches up-to-date library documentation, manages AI coding skills, and sets up Context7 in CLI + Skills mode for your editor.
...
- **[Setup](references/setup.md)** — Configure Context7 (CLI + Skills mode) for Claude Code / Cursor / OpenCode.
...
# Setup
ctx7 setup --cli                      # Configure Context7 in CLI + Skills mode
