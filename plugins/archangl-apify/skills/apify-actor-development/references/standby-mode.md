...
Use Standby when the Actor must handle interactive, real-time HTTP requests — API endpoints, webhook receivers, real-time data lookups, tool servers, or scraping APIs serving on-demand single-URL requests.
