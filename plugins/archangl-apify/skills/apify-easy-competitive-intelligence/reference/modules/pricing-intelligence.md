...
apify actors call: apify/website-content-crawler  # [competitor]/pricing for each vendor

# E-commerce products (if applicable)
apify actors call: junglee/Amazon-crawler
apify actors call: e-commerce/walmart-product-detail-scraper
