...
(This vendored copy is CLI-only per the marketplace's standing no-MCP rule —
the upstream server-mode subcommands are not documented here and must not be
started. See SNAPSHOT.md.)
