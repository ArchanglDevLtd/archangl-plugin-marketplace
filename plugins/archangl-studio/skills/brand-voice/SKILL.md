...
4. If site copy matters, include the current ECC landing page and repo/plugin framing.
...
If the user wants "default" voice and live sources are thin, start here unless newer source material overrides it:
