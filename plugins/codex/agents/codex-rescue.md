...
- If the user asks for `spark`, map that to `--model gpt-5.6-codex-spark`.
- If the user asks for a concrete model name such as `gpt-5.6-mini`, pass it through with `--model`.
