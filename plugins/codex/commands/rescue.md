...
- Model selection follows the owner override in the codex skills: ask the owner which model to use (with a run-time grounded recommendation and an effort level); pass their choice through with `--model` verbatim.
