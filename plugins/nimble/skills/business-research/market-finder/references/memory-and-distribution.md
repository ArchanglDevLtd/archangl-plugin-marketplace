...
After presenting output, offer sharing based on the integrations available in the
session's tool list.

### Integration Detection

Check before presenting options:
- **Notion:** a Notion page-creation tool is available in the session
- **Slack:** a Slack message-posting tool is available in the session
...
> **Tip:** If you connect a Notion or Slack integration to this session, I can save
> reports or post TL;DRs to your team automatically.
